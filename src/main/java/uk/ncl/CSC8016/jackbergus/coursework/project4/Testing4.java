...
import uk.ncl.CSC8016.jackbergus.coursework.project4.solution.WrongBankNoConcurrency;
...
public class Testing4 {
    ...
    public static @NotNull List<Message> testI_1() {
        ...
        var b = new WrongBankNoConcurrency(users);
        List<Message> messages = new ArrayList<>();
        var test = testBlockingEvent(() -> b.openTransaction("three").isEmpty(), 1);
    ...
    public static @NotNull List<Message> testI_2() {
        ...
        if (!isPresentTest(test))  {
            ...
            if (test.get() != null) {
                ...
                var noBlock = testBlockingEvent(() -> test.get().commit(), 1);
    ...
    public static @NotNull List<Message> testI_3() {
        ...
        if (!isPresentTest(test))  {
            ...
            if (test.get() != null) {
                ...
                var noBlock = testBlockingEvent(() -> test.get().payMoneyToAccount(100), 1);
                ...
                noBlock = testBlockingEvent(() -> test.get().payMoneyToAccount(50), 1);
                if ((!noBlock.isPresent()) || (!noBlock.get())) {
                ...
                var noBlock2 = testBlockingEvent(() -> test.get().commit(), 1);
                ...
                noBlock2 = testBlockingEvent(() -> test.get().commit(), 1);
                if (isPresentTest(noBlock2)) {
    ...
    public static @NotNull List<Message> testI_4() {
        ...
        if (!isPresentTest(test))  {
            ...
            if (test.get() != null) {
                ...
                var noBlock = testBlockingEvent(() -> test.get().withdrawMoney(0.0), 1);
                if ((!noBlock.isPresent()) || (!noBlock.get())) {
                ...
                noBlock = testBlockingEvent(() -> test.get().withdrawMoney(100.0), 1);
                if ((!noBlock.isPresent()) || (noBlock.get())) {
                ...
                noBlock = testBlockingEvent(() -> test.get().withdrawMoney(51.0), 1);
                if ((!noBlock.isPresent()) || (!noBlock.get())) {
